...
[is-performance-execution] $ /bin/bash /tmp/jenkins5608461505304220758.sh
...
Completed 1.6 KiB/1.6 KiB (17.9 KiB/s) with 1 file(s) remaining
...
[[1;34mINFO[m] Finished at: 2026-03-11T11:43:57Z
[[1;34mINFO[m] [1m------------------------------------------------------------------------[m
...
Results will be downloaded to /build/jenkins-home/workspace/product-performance-test/is-performance-execution/workspace/performance-is/single-node/results-2026-03-11--11-43-57

Extracting IS Performance Distribution to /build/jenkins-home/workspace/product-performance-test/is-performance-execution/workspace/performance-is/single-node/results-2026-03-11--11-43-57

Estimating time for performance tests: /build/jenkins-home/workspace/product-performance-test/is-performance-execution/workspace/performance-is/single-node/results-2026-03-11--11-43-57/jmeter/run-performance-tests.sh -t -b mysql -g 1 -a false -r 50-50 -v PUBLISH -f single-node -k n7LluuvpsdAyggBQV2TQyiVfKMwa -o test_Pswrd01 -z true -d 5 -w 2 -i Adaptive_Script
...
Script execution time: 1 second(s)
your key is
...
Bastion Node Public IP: 54.160.96.223

Getting NGinx Instance Private IP...
NGinx Instance Private IP: 10.0.1.107

Getting WSO2 IS Node 1 Private IP...
WSO2 IS Node 1 Private IP: 10.0.1.43

Getting RDS Hostname...
RDS Hostname: wso2isdbinstance14259.cvcrys1zedh5.us-east-1.rds.amazonaws.com

Getting Session DB RDS Hostname...
Session DB RDS Hostname: wso2issessiondbinstance14259.cvcrys1zedh5.us-east-1.rds.amazonaws.com

Copying files to Bastion node...
============================================
scp -r -i /build/jenkins-home/workspace/product-performance-test/is-performance-execution/resources/is-perf-test.pem -o StrictHostKeyChecking=no /build/jenkins-home/workspace/product-performance-test/is-performance-execution/workspace/performance-is/single-node/results-2026-03-11--11-43-57/setup ubuntu@54.160.96.223:/home/ubuntu/
Warning: Permanently added '54.160.96.223' (ECDSA) to the list of known hosts.
scp -i /build/jenkins-home/workspace/product-performance-test/is-performance-execution/resources/is-perf-test.pem -o StrictHostKeyChecking=no target/is-performance-*.tar.gz ubuntu@54.160.96.223:/home/ubuntu
scp -i /build/jenkins-home/workspace/product-performance-test/is-performance-execution/resources/is-perf-test.pem -o StrictHostKeyChecking=no /build/jenkins-home/workspace/product-performance-test/is-performance-execution/resources/apache-jmeter-5.3.tgz ubuntu@54.160.96.223:/home/ubuntu/
scp -i /build/jenkins-home/workspace/product-performance-test/is-performance-execution/resources/is-perf-test.pem -o StrictHostKeyChecking=no /build/jenkins-home/workspace/product-performance-test/is-performance-execution/wso2is.zip ubuntu@54.160.96.223:/home/ubuntu/wso2is.zip
scp -i /build/jenkins-home/workspace/product-performance-test/is-performance-execution/resources/is-perf-test.pem -o StrictHostKeyChecking=no /build/jenkins-home/workspace/product-performance-test/is-performance-execution/resources/is-perf-test.pem ubuntu@54.160.96.223:/home/ubuntu/private_key.pem
scp -r -i /build/jenkins-home/workspace/product-performance-test/is-performance-execution/resources/is-perf-test.pem -o StrictHostKeyChecking=no /build/jenkins-home/workspace/product-performance-test/is-performance-execution/workspace/performance-is/single-node/results-2026-03-11--11-43-57/lib/* ubuntu@54.160.96.223:/home/ubuntu/
...
============================================
scp -i /build/jenkins-home/workspace/product-performance-test/is-performance-execution/resources/is-perf-test.pem -o StrictHostKeyChecking=no /tmp/graaljs-sidecar.jar ubuntu@54.160.96.223:/home/ubuntu/graaljs-sidecar-1.0.0.jar

Running Bastion Node setup script...
============================================
ssh -i /build/jenkins-home/workspace/product-performance-test/is-performance-execution/resources/is-perf-test.pem -o StrictHostKeyChecking=no -t ubuntu@54.160.96.223 sudo ./setup/setup-bastion.sh -n 1 -w 10.0.1.43 -i x.x.x.x -j x.x.x.x -k x.x.x.x -r wso2isdbinstance14259.cvcrys1zedh5.us-east-1.rds.amazonaws.com -s wso2issessiondbinstance14259.cvcrys1zedh5.us-east-1.rds.amazonaws.com -l 10.0.1.107
Pseudo-terminal will not be allocated because stdin is not a terminal.
...
============================================
workspace/setup/setup-jmeter-client.sh -g -k /home/ubuntu/private_key.pem -i /home/ubuntu -c /home/ubuntu -f /home/ubuntu/apache-jmeter-5.3.tgz -a wso2is1 -n 10.0.1.43 -a loadbalancer -n 10.0.1.107 -a rds -n wso2isdbinstance14259.cvcrys1zedh5.us-east-1.rds.amazonaws.com -a sessionrds -n wso2issessiondbinstance14259.cvcrys1zedh5.us-east-1.rds.amazonaws.com -w http://search.maven.org/remotecontent?filepath=org/mortbay/jetty/alpn/alpn-boot/8.1.12.v20180117/alpn-boot-8.1.12.v20180117.jar -o /opt/alpnboot/alpnboot.jar -j bzm-parallel
...
============================================
Warning: Permanently added '10.0.1.107' (ECDSA) to the list of known hosts.
...
============================================
ssh -i /build/jenkins-home/workspace/product-performance-test/is-performance-execution/resources/is-perf-test.pem -o StrictHostKeyChecking=no -t ubuntu@54.160.96.223 cd /home/ubuntu/ ; unzip -q wso2is.zip ; mv wso2is-* wso2is
Pseudo-terminal will not be allocated because stdin is not a terminal.
ssh -i /build/jenkins-home/workspace/product-performance-test/is-performance-execution/resources/is-perf-test.pem -o StrictHostKeyChecking=no -t ubuntu@54.160.96.223 mysql -h wso2isdbinstance14259.cvcrys1zedh5.us-east-1.rds.amazonaws.com -u wso2carbon -pwso2carbon < /home/ubuntu/workspace/setup/resources/mysql/create_database.sql
Pseudo-terminal will not be allocated because stdin is not a terminal.
mysql: [Warning] Using a password on the command line interface can be insecure.

Creating session database in RDS...
ssh -i /build/jenkins-home/workspace/product-performance-test/is-performance-execution/resources/is-perf-test.pem -o StrictHostKeyChecking=no -t ubuntu@54.160.96.223 mysql -h wso2issessiondbinstance14259.cvcrys1zedh5.us-east-1.rds.amazonaws.com -u wso2carbon -pwso2carbon < /home/ubuntu/workspace/setup/resources/mysql/create_session_database.sql
Pseudo-terminal will not be allocated because stdin is not a terminal.
mysql: [Warning] Using a password on the command line interface can be insecure.

Running IS node 1 setup script...
============================================
ssh -i /build/jenkins-home/workspace/product-performance-test/is-performance-execution/resources/is-perf-test.pem -o StrictHostKeyChecking=no -t ubuntu@54.160.96.223 ./setup/setup-is.sh -n 1 -m mysql -c false -a wso2is1 -t PKCS12 -i 10.0.1.43 -w x.x.x.x -j x.x.x.x -k x.x.x.x -r wso2isdbinstance14259.cvcrys1zedh5.us-east-1.rds.amazonaws.com -s wso2issessiondbinstance14259.cvcrys1zedh5.us-east-1.rds.amazonaws.com -g true
Pseudo-terminal will not be allocated because stdin is not a terminal.

Copying Is server setup files...
-------------------------------------------
Warning: Permanently added '10.0.1.43' (ECDSA) to the list of known hosts.
...
Fetched 167 kB in 0s (15.3 MB/s)
...
debconf: falling back to frontend: Teletype
dpkg-preconfigure: unable to re-open stdin: 
Fetched 276 kB in 0s (7332 kB/s)
...
debconf: falling back to frontend: Teletype
dpkg-preconfigure: unable to re-open stdin: 
Fetched 324 kB in 0s (17.2 MB/s)
...
Running update-is-conf script: ssh -i ~/private_key.pem -o StrictHostKeyChecking=no -t ubuntu@10.0.1.43       ./update-is-conf.sh -n 1 -c false -r wso2isdbinstance14259.cvcrys1zedh5.us-east-1.rds.amazonaws.com -m mysql -t PKCS12 -s wso2issessiondbinstance14259.cvcrys1zedh5.us-east-1.rds.amazonaws.com -g true
============================================
Pseudo-terminal will not be allocated because stdin is not a terminal.
...
-------------------------------------------
GraalJS sidecar started with PID: 11463
GraalJS sidecar is running on localhost:50051.

Running performance tests...
============================================
scp -i /build/jenkins-home/workspace/product-performance-test/is-performance-execution/resources/is-perf-test.pem -o StrictHostKeyChecking=no run-performance-tests.sh ubuntu@54.160.96.223:/home/ubuntu/workspace/jmeter
ssh -i /build/jenkins-home/workspace/product-performance-test/is-performance-execution/resources/is-perf-test.pem -o StrictHostKeyChecking=no -t ubuntu@54.160.96.223 ./workspace/jmeter/run-performance-tests.sh -p 443 -b mysql -g 1 -a false -r 50-50 -v PUBLISH -f single-node -k n7LluuvpsdAyggBQV2TQyiVfKMwa -o test_Pswrd01 -z true -d 5 -w 2 -i Adaptive_Script
Pseudo-terminal will not be allocated because stdin is not a terminal.
Pseudo-terminal will not be allocated because stdin is not a terminal.
Running tests for concurrency level 50
...
==========================================================================================
jmeter -n -t /home/ubuntu/workspace/jmeter/setup/TestData_SCIM2_Add_User.jmx -Jhost=10.0.1.107 -Jport=443 -JtokenIssuer=Default -JnoOfNodes=1 -JuserCount=1000 -l test_data_store/results.jtl

Mar 11, 2026 12:00:08 PM java.util.prefs.FileSystemPreferences$1 run
INFO: Created user preferences directory.
Creating summariser <summary>
Created the tree successfully using /home/ubuntu/workspace/jmeter/setup/TestData_SCIM2_Add_User.jmx
Starting standalone test @ Wed Mar 11 12:00:08 UTC 2026 (1773230408363)
Waiting for possible Shutdown/StopTestNow/HeapDump/ThreadDump message on port 4445
Warning: Nashorn engine is planned to be removed from a future JDK release
summary +    226 in 00:00:21 =   10.6/s Avg:    92 Min:    69 Max:  1052 Err:     0 (0.00%) Active: 1 Started: 3 Finished: 2
summary +    373 in 00:00:30 =   12.4/s Avg:    79 Min:    73 Max:   137 Err:     0 (0.00%) Active: 1 Started: 3 Finished: 2
summary =    599 in 00:00:51 =   11.6/s Avg:    84 Min:    69 Max:  1052 Err:     0 (0.00%)
summary +    383 in 00:00:30 =   12.8/s Avg:    77 Min:    72 Max:   139 Err:     0 (0.00%) Active: 1 Started: 3 Finished: 2
summary =    982 in 00:01:21 =   12.1/s Avg:    81 Min:    69 Max:  1052 Err:     0 (0.00%)
summary +     20 in 00:00:02 =   13.0/s Avg:    76 Min:    74 Max:    80 Err:     0 (0.00%) Active: 0 Started: 3 Finished: 3
summary =   1002 in 00:01:23 =   12.1/s Avg:    81 Min:    69 Max:  1052 Err:     0 (0.00%)
Tidying up ...    @ Wed Mar 11 12:01:31 UTC 2026 (1773230491558)
... end of run
...
==========================================================================================
  ...
  Command:   /home/ubuntu/workspace/jmeter/setup/setup-adaptive-script-app.sh -h 10.0.1.107 -p 443 -u 1000 -m 0 -a 0
==========================================================================================
============================================================
  Adaptive Script App Setup (IS 7.2.x)
  IS: https://10.0.1.107:443
...
Pre-flight: Checking IS connectivity at https://10.0.1.107:443 ...
  IS is reachable (HTTP 200).

Step 1: Creating OAuth application: AdaptiveScriptPerfTestApp ...
...
Starting standalone test @ Wed Mar 11 12:03:16 UTC 2026 (1773230596751)
Waiting for possible Shutdown/StopTestNow/HeapDump/ThreadDump message on port 4445
Warning: Nashorn engine is planned to be removed from a future JDK release
summary +    230 in 00:00:13 =   17.7/s Avg:    35 Min:     2 Max:   805 Err:    45 (19.57%) Active: 50 Started: 50 Finished: 0
summary +   1009 in 00:00:30 =   33.5/s Avg:     4 Min:     1 Max:    63 Err:   252 (24.98%) Active: 50 Started: 50 Finished: 0
summary =   1239 in 00:00:43 =   28.7/s Avg:     9 Min:     1 Max:   805 Err:   297 (23.97%)
summary +   1035 in 00:00:30 =   34.7/s Avg:     3 Min:     1 Max:    43 Err:   259 (25.02%) Active: 50 Started: 50 Finished: 0
summary =   2274 in 00:01:13 =   31.1/s Avg:     7 Min:     1 Max:   805 Err:   556 (24.45%)
summary +   1001 in 00:00:30 =   33.2/s Avg:     3 Min:     1 Max:   168 Err:   250 (24.98%) Active: 50 Started: 50 Finished: 0
summary =   3275 in 00:01:43 =   31.8/s Avg:     6 Min:     1 Max:   805 Err:   806 (24.61%)
summary +    978 in 00:00:30 =   32.7/s Avg:     3 Min:     1 Max:    16 Err:   244 (24.95%) Active: 50 Started: 50 Finished: 0
summary =   4253 in 00:02:13 =   32.0/s Avg:     5 Min:     1 Max:   805 Err:  1050 (24.69%)
summary +   1007 in 00:00:30 =   33.5/s Avg:     3 Min:     1 Max:    15 Err:   252 (25.02%) Active: 50 Started: 50 Finished: 0
summary =   5260 in 00:02:43 =   32.3/s Avg:     5 Min:     1 Max:   805 Err:  1302 (24.75%)
summary +   1015 in 00:00:30 =   33.8/s Avg:     3 Min:     1 Max:    16 Err:   254 (25.02%) Active: 50 Started: 50 Finished: 0
summary =   6275 in 00:03:13 =   32.5/s Avg:     4 Min:     1 Max:   805 Err:  1556 (24.80%)
summary +    984 in 00:00:30 =   32.4/s Avg:     3 Min:     1 Max:    12 Err:   246 (25.00%) Active: 50 Started: 50 Finished: 0
summary =   7259 in 00:03:43 =   32.5/s Avg:     4 Min:     1 Max:   805 Err:  1802 (24.82%)
summary +    964 in 00:00:30 =   32.5/s Avg:     3 Min:     1 Max:    23 Err:   241 (25.00%) Active: 50 Started: 50 Finished: 0
summary =   8223 in 00:04:13 =   32.5/s Avg:     4 Min:     1 Max:   805 Err:  2043 (24.84%)
summary +   1012 in 00:00:30 =   33.5/s Avg:     3 Min:     1 Max:    14 Err:   253 (25.00%) Active: 50 Started: 50 Finished: 0
summary =   9235 in 00:04:43 =   32.6/s Avg:     4 Min:     1 Max:   805 Err:  2296 (24.86%)
summary +    547 in 00:00:16 =   33.5/s Avg:     2 Min:     1 Max:    20 Err:   137 (25.05%) Active: 0 Started: 50 Finished: 50
summary =   9782 in 00:05:00 =   32.6/s Avg:     4 Min:     1 Max:   805 Err:  2433 (24.87%)
Tidying up ...    @ Wed Mar 11 12:08:16 UTC 2026 (1773230896653)
... end of run
...
Script execution time: 8 minute(s) and 14 second(s)

Downloading results...
============================================
scp -i /build/jenkins-home/workspace/product-performance-test/is-performance-execution/resources/is-perf-test.pem -o StrictHostKeyChecking=no ubuntu@54.160.96.223:/home/ubuntu/results.zip /build/jenkins-home/workspace/product-performance-test/is-performance-execution/workspace/performance-is/single-node/results-2026-03-11--11-43-57/
...
Saving stack events to /build/jenkins-home/workspace/product-performance-test/is-performance-execution/workspace/performance-is/single-node/results-2026-03-11--11-43-57/stack-events.json

Deleting the stack: arn:aws:cloudformation:us-east-1:125035497591:stack/is-performance-single-node--2026-03-11--11-43-57--14259/9805d420-1d3f-11f1-b443-12c5bf57ddf1

Polling till the stack deletion completes...
Stack deletion time: 5 minute(s) and 03 second(s)
Script execution time: 29 minute(s) and 40 second(s)
Completed 256.0 KiB/5.2 MiB (3.0 MiB/s) with 9 file(s) remaining
...
Completed 1.0 MiB/5.2 MiB (11.1 MiB/s) with 9 file(s) remaining 
Completed 1.2 MiB/5.2 MiB (13.7 MiB/s) with 9 file(s) remaining 
Completed 1.5 MiB/5.2 MiB (15.9 MiB/s) with 9 file(s) remaining 
Completed 1.8 MiB/5.2 MiB (18.1 MiB/s) with 9 file(s) remaining 
Completed 2.0 MiB/5.2 MiB (20.5 MiB/s) with 9 file(s) remaining 
Completed 2.2 MiB/5.2 MiB (22.8 MiB/s) with 9 file(s) remaining 
Completed 2.5 MiB/5.2 MiB (25.0 MiB/s) with 9 file(s) remaining 
Completed 2.8 MiB/5.2 MiB (26.7 MiB/s) with 9 file(s) remaining 
Completed 3.0 MiB/5.2 MiB (28.7 MiB/s) with 9 file(s) remaining 
Completed 3.2 MiB/5.2 MiB (30.7 MiB/s) with 9 file(s) remaining 
Completed 3.5 MiB/5.2 MiB (32.6 MiB/s) with 9 file(s) remaining 
Completed 3.5 MiB/5.2 MiB (32.2 MiB/s) with 9 file(s) remaining 
upload: results-2026-03-11--11-43-57/results.zip to s3://performance-is-resources/Results/4446/results.zip
Completed 3.5 MiB/5.2 MiB (32.2 MiB/s) with 8 file(s) remaining
Completed 3.8 MiB/5.2 MiB (34.1 MiB/s) with 8 file(s) remaining
Completed 4.0 MiB/5.2 MiB (36.2 MiB/s) with 8 file(s) remaining
Completed 4.3 MiB/5.2 MiB (38.0 MiB/s) with 8 file(s) remaining
Completed 4.5 MiB/5.2 MiB (39.5 MiB/s) with 8 file(s) remaining
Completed 4.8 MiB/5.2 MiB (41.2 MiB/s) with 8 file(s) remaining
Completed 4.8 MiB/5.2 MiB (40.7 MiB/s) with 8 file(s) remaining
upload: results-2026-03-11--11-43-57/summary.csv to s3://performance-is-resources/Results/4446/summary.csv
Completed 4.8 MiB/5.2 MiB (40.7 MiB/s) with 7 file(s) remaining
Completed 4.8 MiB/5.2 MiB (39.1 MiB/s) with 7 file(s) remaining
upload: results-2026-03-11--11-43-57/summary.md to s3://performance-is-resources/Results/4446/summary.md
Completed 4.8 MiB/5.2 MiB (39.1 MiB/s) with 6 file(s) remaining
Completed 4.8 MiB/5.2 MiB (38.5 MiB/s) with 6 file(s) remaining
upload: results-2026-03-11--11-43-57/summary-original.csv to s3://performance-is-resources/Results/4446/summary-original.csv
Completed 4.8 MiB/5.2 MiB (38.5 MiB/s) with 5 file(s) remaining
Completed 4.8 MiB/5.2 MiB (37.6 MiB/s) with 5 file(s) remaining
upload: results-2026-03-11--11-43-57/summary/summary-modifier.py to s3://performance-is-resources/Results/4446/summary/summary-modifier.py
Completed 4.8 MiB/5.2 MiB (37.6 MiB/s) with 4 file(s) remaining
Completed 4.8 MiB/5.2 MiB (32.5 MiB/s) with 4 file(s) remaining
upload: results-2026-03-11--11-43-57/lib/postgresql-42.7.4.jar to s3://performance-is-resources/Results/4446/lib/postgresql-42.7.4.jar
Completed 4.8 MiB/5.2 MiB (32.5 MiB/s) with 3 file(s) remaining
Completed 4.9 MiB/5.2 MiB (31.8 MiB/s) with 3 file(s) remaining
upload: results-2026-03-11--11-43-57/stack-events.json to s3://performance-is-resources/Results/4446/stack-events.json
Completed 4.9 MiB/5.2 MiB (31.8 MiB/s) with 2 file(s) remaining
Completed 5.0 MiB/5.2 MiB (28.5 MiB/s) with 2 file(s) remaining
upload: results-2026-03-11--11-43-57/lib/mysql-connector-j-8.0.33.jar to s3://performance-is-resources/Results/4446/lib/mysql-connector-j-8.0.33.jar
Completed 5.0 MiB/5.2 MiB (28.5 MiB/s) with 1 file(s) remaining
Completed 5.2 MiB/5.2 MiB (29.0 MiB/s) with 1 file(s) remaining
upload: results-2026-03-11--11-43-57/lib/mssql-jdbc-12.8.1.jre11.jar to s3://performance-is-resources/Results/4446/lib/mssql-jdbc-12.8.1.jre11.jar
==========================================================
